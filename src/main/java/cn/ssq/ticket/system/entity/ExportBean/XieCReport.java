...
public class XieCReport extends Purchase{
	...
	/*@ExcelField(title="出票单号", align=1, sort=20)
	public String getcOrderNo(){
		return super.getPassengerList().get(0).getcOrderNo();
	}*/
	...
	@ExcelField(title="携程总价", align=3, sort=50)
