...
public class Flight implements Serializable
{
	...
	public String getNewDepDate() {
		return newDepDate;
	}
	public void setNewDepDate(String newDepDate) {
		this.newDepDate = newDepDate;
	}
	public String getNewArrDate() {
		return newArrDate;
	}
	public void setNewArrDate(String newArrDate) {
	...
	public String getNewArrCode() {
		return newArrCode;
	}
	public void setNewArrCode(String newArrCode) {
		this.newArrCode = newArrCode;
	}
	...
	public String toString() {
		return "Flight [flightId=" + flightId + ", orderId=" + orderId
				...
				+ ", newDepDate=" + newDepDate + ", newArrDate=" + newArrDate
				+ ", newFlightNo=" + newFlightNo + ", newDepCode=" + newDepCode
				+ ", newArrCode=" + newArrCode + ", changeCode=" + changeCode
